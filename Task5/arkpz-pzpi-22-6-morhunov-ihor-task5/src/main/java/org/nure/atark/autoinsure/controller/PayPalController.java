...
public class PayPalController {
    ...
    public ResponseEntity<?> pay(@RequestParam Double total, @RequestParam String currency,
        ...
        try {
            String cancelUrl = "https://daring-card-445509-b1.lm.r.appspot.com/api/payments/cancel";
            String successUrl = "https://daring-card-445509-b1.lm.r.appspot.com/api/payments/success?policyId=" + policyId;
